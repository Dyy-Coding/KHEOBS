...
import { ExternalLink, Monitor, Map, BarChart3, Database, Globe, Settings } from 'lucide-react';
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            <div className="flex items-center justify-center h-96 border-2 border-dashed border-gray-300 rounded-lg">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-lg">Interactive Dashboard Embed</p>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="h-48 bg-gradient-to-r from-green-400 to-blue-500 flex items-center justify-center">
                <div className="text-center text-white">
                  ...
                  <p className="font-semibold">Mekong River Conservation</p>
                </div>
              </div>
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-2">Mekong River Conservation Story</h3>
                <p className="text-gray-600 mb-4">
                  Follow the journey of conservation efforts along the Mekong River basin
                </p>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="h-48 bg-gradient-to-r from-yellow-400 to-orange-500 flex items-center justify-center">
                <div className="text-center text-white">
                  ...
                  <p className="font-semibold">Climate Change Impacts</p>
                </div>
              </div>
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-2">Climate Change in Cambodia</h3>
                <p className="text-gray-600 mb-4">
                  Visualize the impacts of climate change on Cambodian communities
                </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Tool Usage Guidelines</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Learn how to effectively use our research tools for your projects
            </p>
          </motion.div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Access & Registration</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Explore & Analyze</h3>
                <p className="text-gray-600">
